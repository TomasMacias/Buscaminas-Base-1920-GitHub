 ...
 * mina, se guarda cuÃ¡ntas minas hay alrededor. Almacena la puntuación de la
 * partida
 * 
...
public class ControlJuego {
	...
	/**
	 * Método para generar un nuevo tablero de partida: i=Lado vertical j = Lado
	 * horizontal.
	 * 
	...
	public void inicializarPartida() {
		...
		puntuacion = 0;
		// TODO: Repartir minas e inicializar puntación. Si hubiese un tablero
		...
		// Al final del método hay que guardar el número de minas para las casillas
		// que no son mina:
		for (i = 0; i < LADO_TABLERO_VERTICAL; i++) {
			for (j = 0; j < LADO_TABLERO_HORIZONTAL; j++) {
				if (tablero[i][j] != MINA) {
